...
// in news_clean_architecture/test/presentation/bloc/news_bloc_test.dart.
...
import 'package:news_clean_architecture/common/failure.dart' as _i6;
...
class MockGetNews extends _i1.Mock implements _i4.GetNews {
  ...
  @override
  _i5.Future<_i3.Either<_i6.Failure, _i7.News>> execute() =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
          [],
